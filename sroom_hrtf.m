function ht = sroom_hrtf(r, r0, rl, roomId, beta, npts, fs, c)
% This function is used to calculate the RIR in a room. Created by Ge Zhongshu
% pgm: sroom
...
% ht : a matrix of N * 5. N represents the number of image sources. The 5 columns represent the time of arrival, the x, y, z coordinates and the reflection order
